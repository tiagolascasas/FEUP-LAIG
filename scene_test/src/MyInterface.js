...
/*	switch (event.keyCode)
	{
		case (87): case (119):	//W w
			this.scene.submarine.move('FORWARD', this.scene.ds);
			break;
		case (65):	case (97):	//A a
			this.scene.submarine.move('R_LEFT', this.scene.ds);
			break;
		case (83): case (115):	//S s
			this.scene.submarine.move('BACKWARD', this.scene.ds);
			break;
		case (68): case (100):	//D d
			this.scene.submarine.move('R_RIGHT', this.scene.ds);
			break;
		default: break;
	};*/
};
